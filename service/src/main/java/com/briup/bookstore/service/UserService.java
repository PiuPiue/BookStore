...
public interface UserService{
     ...
     **/
    PageInfo<UserPageVO> getUserPage(Integer pageNum, Integer pageSize, String username, String status, LocalDateTime startTime, LocalDateTime endTime);
    ...
    void updatePassword(int parseInt, String oldPassword, String newPassword);
}
