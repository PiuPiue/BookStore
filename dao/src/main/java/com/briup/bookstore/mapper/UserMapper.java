...
public interface UserMapper {
    ...
    void  setDefaultAddress(@Param("userId") Integer userId,@Param("addressId") Integer addressId);

    void cancelDefaultAddress(@Param("addressId") Integer addressId);

    int getCountByIdAndUsername(@Param("id") Integer id,@Param("username") String username);

    User getUserByUserIdAndPassword(@Param("userId") Integer userId, @Param("password") String password);
}
